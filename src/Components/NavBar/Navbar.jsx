    ...
    return (
        <section className='sticky top-0 left-0 right-0  z-50 bg-transparent'>
            <div className="div bg-[#123575] py-1 text-center">
                <p className='text-[#ffffff81] font-nunito text-[15px]'>Need to participate programs? <a target='_blank' className='opacity-80 underline' href="https://drive.google.com/drive/folders/1z-Q5CfkDy-2D0T9tDwXYXL6Uv1jrkkSk?usp=drive_link">reach here ⇗</a></p>
            </div>
